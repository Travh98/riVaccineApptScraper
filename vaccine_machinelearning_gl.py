# -*- coding: utf-8 -*-
"""
Created on Sun Apr 18 14:41:25 2021
...
def generate_model_location_weekday():
    ...
    score = accuracy_score(y_test, predictions) * 100  # how accurate the machine learning is (this varies every model)
    score = round(score, 3)
    print(score, "% Machine Learinging Model Accuracy")
...
def see_predicted_week(location):
    ...
    return week_days, this_week_predicted
